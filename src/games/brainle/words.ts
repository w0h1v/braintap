...
const COMMON: readonly string[] = [
  ...
  "ABORT", "ADAGE", "ADIEU", "ADORN", "AFFIX", "AFOOT", "AGATE", "AGING", "AGLOW", "ALIAS",
  "ALIEN", "ALIGN", "ALLEY", "ALLOT", "ALLOY", "ALOFT", "ALOOF", "AMASS", "AMAZE", "AMINO",
  "AMISS", "ANGST", "ANTIC", "ANVIL", "ARDOR", "ARSON", "ASCOT", "ATLAS", "ATOLL", "ATONE",
  "ATTIC", "AUGUR", "AURAL", "AVAIL", "AXIOM", "AZURE", "BAGGY", "BALMY", "BANAL", "BARON",
  "BASIN", "BASTE", "BERTH", "BIBLE", "BIRCH", "BLAND", "BLARE", "BLEAT", "BLIMP", "BLITZ",
  "BLOND", "BLUFF", "BLURT", "BLUSH", "BONGO", "BONUS", "BORAX", "BOSOM", "BOUGH", "BOWEL",
  "ALOHA", "BRAKE", "BREAM", "BRICK", "BRIDE", "BRINY", "BROOD", "BUDDY", "BUGGY", "BULGE",
  "BULLY", "BUMPY", "BUNNY", "BURNT", "BURRO", "BUTTE", "BYWAY", "CACAO", "CALVE", "CANOE",
  "CARAT", "CASTE", "CEASE", "CHAFF", "CHESS", "CHICK", "CHIVE", "CHOKE", "CHORE", "CIVET",
  "AMIGO", "COCKY", "COMBO", "CONGA", "COTTA", "COUPE", "CRIER", "CUTER", "DAIRY", "DAZED",
  "DERMA", "DINER", "DIODE", "DIRGE", "DISCO", "DIZZY", "DONNA", "DOPEY", "DOUGH", "DREAR",
  "DUCAT", "DUSTY", "ELATE", "ELFIN", "EMCEE", "ENVOY", "EPOXY", "ERASE", "EVICT", "EXILE",
  "EXTOL", "FEINT", "EPICS", "FLEER", "FUNDS", "FURRY", "GAFFE", "GAUSS", "GEMMY", "GLUME",
  "GNARL", "GOOFY", "GORSE", "GREBE", "GROWL", "GUTSY", "HAUNT", "HEATH", "HEDGE", "HENNA",
  "HOAGY", "HOGAN", "HOMER", "HOMEY", "HORDE", "HUBBY", "HUGER", "HUMUS", "ICIER", "IDLER",
  "IDYLL", "IMBUE", "INBOX", "INCUR", "INDIE", "KENDO", "KIDDO", "KLUTZ", "KNELL", "KNOLL",
  "KRILL", "LAGER", "LASSO", "LAYUP", "LEASH", "LEERY", "LEFTY", "LEGGY", "LENTO", "LEPER",
  "LIANA", "LIEGE", "LIFER", "LIPID", "LOCUS", "LONER", "LOSER", "LOTTO", "LUGER", "MAGMA",
  "MANGE", "MANIC", "MAVEN", "MEATY", "MERCY", "MISER", "MISTY", "MODAL", "MONAD", "MOODY",
  "MOULD", "MOURN", "MOWER", "MYRRH", "NODAL", "NOTCH", "OBESE", "OLDIE", "OVERT", "OVOID",
];
